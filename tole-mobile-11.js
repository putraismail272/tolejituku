...
// Slider
$('<div class="splide"><div class="splide__track"><ul class="splide__list"><li class="splide__slide"><img src="https://i.postimg.cc/brFDhWbq/pop-up-ttm-TJ-min.png" style="width: 100%;" /></li><li class="splide__slide"><img src="https://i.postimg.cc/FHv2MQkJ/slider-togel-promo.jpg" style="width: 100%;" /></li><li class="splide__slide"><img src="https://i.postimg.cc/SxGwqtc1/slider-togel-Xtra-TO.jpg" style="width: 100%;"/></li><li class="splide__slide"><img src="https://i.postimg.cc/V62hDycv/slider-togel-hadiah.jpg" style="width: 100%;" /></li></ul></div><div class="splide__progress"><div class="splide__progress__bar"></div></div></div>').insertBefore($('.wrapper2'));
...
splide.mount(); 
			// Popup
			$('body').append('<div id="pop-up-container" onclick="close_pop_up()"><div id="bg-black" class="fade-in"></div><div id="pop-up-wrapper" class="swirl-in-fwd gray-bg"><a href="#" target=""><img src="https://i.postimg.cc/P5yVKh1k/Hadiah-togel-TJ.jpg" alt="tolejitu"/></a><button onclick="close_pop_up()">Klik di sini untuk tutup</button></div></div>');
