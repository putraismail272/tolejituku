...
//Teks Berjalan
$('<table style="font-size: 13px;border: none;margin-bottom: -14px;margin-top: -10px;"><tbody><tr><td style="text-align: center;padding: 0px 2px 5px 5px;font-size: 11px;background: #b90b1f; border: none;"><i class="fas fa-bullhorn"></i></td><td style="background: #252525;border: none;"><marquee>Selamat Datang di Tolejitu</marquee></td></tr></tbody></table>').insertBefore($('.wrapper2'));

// Slider
$('<div class="splide"><div class="splide__track"><ul class="splide__list"><li class="splide__slide"><img src="https://i.postimg.cc/02yCb1D8/Slider-All-Promo.jpg" style="width: 100%;" /></li><li class="splide__slide"><img src="https://i.postimg.cc/V64C857X/Slider-togel-Hadiah.jpg" style="width: 100%;" /></li><li class="splide__slide"><img src="https://i.postimg.cc/J0nB4mgv/Slider-Xtra-TO.jpg" style="width: 100%;" /></li></ul></div><div class="splide__progress"><div class="splide__progress__bar"></div></div></div>').insertBefore($('.wrapper2'));


// icon List Mobile
$('<div class="list-menu-mobile"><a href="https://prediksitogeljitu.org/?page=bukti-jp-member" target="_blank"><img src="https://i.postimg.cc/B6kZhFXq/Button-bukti-JP-TJ.png" alt="TOGEL"></a><a href="https://prediksitogeljitu.org/?page=prediksi-mobile" target="_blank"><img src="https://i.postimg.cc/DzmKtZVm/Button-prediksi-togel-TJ.png" alt="SLOT"></a><a href="https://tolejitu.com/m/promosi_index.php" target="_blank"><img src="https://i.postimg.cc/Z55kdR5j/Button-promo-TJ.png" alt="Carabermain"></a><a href="https://prediksitogeljitu.org/?page=slot-gacor" target="_blank"><img src="https://i.postimg.cc/cJvVFbYn/Button-rtp-TJ.png" alt="PROMOSI"></a></div>').insertBefore($(".wrapper2"));
...
splide.mount(); 
			// Popup
			$('body').append('<div id="pop-up-container" onclick="close_pop_up()"><div id="bg-black" class="fade-in"></div><div id="pop-up-wrapper" class="swirl-in-fwd gray-bg"><a href="#" target=""><img src="https://i.postimg.cc/ZRsbWn6c/POP-UP-TOLEJITU.png" alt="tolejitu"/></a><button onclick="close_pop_up()">Klik di sini untuk tutup</button></div></div>');
