...
// Slider
$('<div class="splide"><div class="splide__track"><ul class="splide__list"><li class="splide__slide"><img src="https://i.postimg.cc/qMtjF63T/Hadiah-togel-TJ.jpg" style="width: 100%;" /></li><li class="splide__slide"><img src="https://i.postimg.cc/FH3GrtpC/Slider-All-Promo.jpg" style="width: 100%;" /></li><li class="splide__slide"><img src="https://i.postimg.cc/PqM4DmBm/Slider-Xtra-TO.jpg" style="width: 100%;" /></li></ul></div><div class="splide__progress"><div class="splide__progress__bar"></div></div></div>').insertBefore($('.wrapper2'));


// icon List Mobile
$('<div class="list-menu-mobile"><a href="https://prediksitolejitu.com/?page=bukti-jp-member" target="_blank"><img src="https://i.postimg.cc/7Y1Ny2qy/Button-Bukti-JP.jpg" alt="TOGEL" style="width: 25%; height: auto;"></a><a href=https://prediksitolejitu.com/?page=prediksi-mobile" target="_blank"><img src="https://i.postimg.cc/dVqjQV0Z/Button-Prediksi-Togel.jpg" alt="SLOT"style="width: 25%; height: auto;"></a><a href="https://tolejitu.net/m/promosi_index.php" target="_blank"><img src="https://i.postimg.cc/cLXMvGK9/Button-Promo.jpg" alt="Carabermain"style="width: 25%; height: auto;"></a><a href="https://prediksitolejitu.com/?page=slot-gacor" target="_blank"><img src="https://i.postimg.cc/W4zmrYg2/Button-RTP-Slot.jpg" alt="PROMOSI"style="width: 25%; height: auto;"></a></div>').insertBefore($(".wrapper2"));
...
splide.mount(); 
			// Popup
			$('body').append('<div id="pop-up-container" onclick="close_pop_up()"><div id="bg-black" class="fade-in"></div><div id="pop-up-wrapper" class="swirl-in-fwd gray-bg"><a href="#" target=""><img src="https://iili.io/Jcf1QcX.png" alt="tolejitu"/></a><button onclick="close_pop_up()">Klik di sini untuk tutup</button></div></div>')
