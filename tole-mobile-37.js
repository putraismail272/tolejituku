...
// qris
<div class="note center"><button class="btn-qrishome" id="buttonQrisOpen">Deposit QRIS</button> <div id="qris" class="qrisPopup" style="display: none;"><div class="modal modal-mobile-qris"><div class="modal-container-mobile-qris"><div class="body"><a href="https://i.postimg.cc/pdZdZy1R/ID1023307768425-1.png" target="event"><img src="https://i.postimg.cc/pdZdZy1R/ID1023307768425-1.png" class="popup-img"></a><div class="modal-header box"><button type="button" class="btn-close close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">X TUTUP</span></button></div></div></div></div></div></div>
