...
// qris
<div class="note center"><button class="btn-qrishome" id="buttonQrisOpen">Deposit QRIS</button> <div id="qris" class="qrisPopup" style="display: none;"><div class="modal modal-mobile-qris"><div class="modal-container-mobile-qris"><div class="body"><a href="https://postimg.cc/p9mxVVH6" target="event"><img src="https://postimg.cc/p9mxVVH6" class="popup-img"></a><div class="modal-header box"><button type="button" class="btn-close close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">X TUTUP</span></button></div></div></div></div></div></div>	
